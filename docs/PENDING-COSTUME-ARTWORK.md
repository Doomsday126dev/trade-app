...
Production release `2026-08-29.80` contains 28 canonical costume identities with honest placeholders. After merged PR #44, the source candidate for release `2026-08-30.84` contains 21. The seven resolved identities are exact reviewed artwork records in source and are no longer part of this inventory.
