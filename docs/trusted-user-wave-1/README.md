...
Invite 3–5 trusted Pokémon GO traders. Test accepted production release `2026-08-30.82`; do not use a preview branch. Each tester should use their own disposable test entries and avoid deleting anything they care about.
