...
test('all section combinations retain exact manual checks and unknown variants in every query locale',()=>{
  ...
  for(const locale of ['en','ja','es','de']){
    ...
    const expected={en:'!4*&CP-2500&!shadow&!purified&!background&25,133',ja:'!4*&cp-2500&!しゃどう&!らいと&!はいけい&25,133',es:'!4*&PC-2500&!oscuro&!purificado&!fondo&25,133',de:'!4*&WP-2500&!Crypto&!Erlöst&!hintergrund&25,133'};
