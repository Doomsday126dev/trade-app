...
const rollbackSource=currentSource.replace("const RELEASE='2026-08-05.46';",`const RELEASE='${targetRelease}';`);
...
function harness({failUrl=''}={}){
  ...
  const newer='shell-pogo-trades-2026-08-05.46',newerSprites='sprites-pogo-trades-2026-08-05.46';
  const newerCache=new MemoryCache();newerCache.values.set('./index.html?v=2026-08-05.46',response(200,'newer-shell'));
