...
test('release 2026-08-29.80 is coherent and contains no active .66 assets',()=>{
  ...
  for(const src of firstParty)assert.equal(new URL(src,'https://example.test').searchParams.get('v'),'2026-08-29.80');
