...
test('release 2026-08-25.63 is coherent and contains no active .62 assets',()=>{
  const worker=source('sw.js'),release=source('js/domain/clientRelease.js');
  assert.match(html,/window\.__POGO_RELEASE_ID='2026-08-25\.63'/);
  ...
  assert.equal(firstParty.length,63);
