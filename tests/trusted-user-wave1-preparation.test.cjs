...
test('Wave 1 artwork inventory distinguishes production .80 from the .85 source candidate',()=>{
...
test('Wave 1 kit covers all independent journeys, severity levels, cleanup, and honest results',()=>{
  ...
  for(const item of ['2026-08-31.86','21 pending reviewed costume artworks','42 background eligibility mappings','background artwork/source strategy','optional Special Trade Board background filter','account-isolation sync scenario not exercised','EN, JA, ES, and DE'])assert.match(readme,new RegExp(item));
