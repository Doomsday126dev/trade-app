...
const { CONTRACT } = require('./identity-fence');
...
function configuredService() {
  if (process.env.LEGACY_PIN_RESET_ENABLED !== 'true' || process.env.LEGACY_IDENTITY_BOUNDARY !== CONTRACT || process.env.GCLOUD_PROJECT !== PROJECT ||
