...
try {
  const result = guardE1Target({
    ...
    operationGates: {
      ...
      READ_PROVIDER_PUBLIC_SHARE_ENABLED: process.env.READ_PROVIDER_PUBLIC_SHARE_ENABLED,
      CREATE_PROVIDER_ACCOUNT_ENABLED: process.env.CREATE_PROVIDER_ACCOUNT_ENABLED,
