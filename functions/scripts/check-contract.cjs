...
assert.deepEqual(exported, ['claimTrainerTagLabel', 'reserveTrainerHandle', 'setApprovedViewer', 'verifyTrainerHistory']);
...
console.log('Trusted Functions contract check passed: 4 fixed callables, no generic adapter or deploy capability.');
